            ...
            <div class="container-fluid">
                <fieldset disabled>
                    ...
                    <div class="d-flex justify-content-center">
                        <a class="btn-custom mb-3 mx-3 col-auto btnAnnulerRetour-custom" href="{{ route('Inscription.RBQ') }}"> <i class="fa fa-arrow-left me-2"></i>Précédent</a>
                        <button type="submit" class="btnConfirmerEnvoyer-custom btn-custom mb-3 mx-3 col-auto">  <i class="fa fa-check-circle me-2"></i>Confirmer et envoyer le formulaire</button>
                    </div>
