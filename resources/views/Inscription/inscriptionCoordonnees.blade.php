                ...
                <div class="container-fluid">
                    ...
                    <p class="col-12 text-center my-3 titre">Information de votre entreprise</p>
                       ...
                       <div class="mb-3">
                           ...
                           <input type="text" class="col-9" id="bureau" placeholder="exemple : suite 103" name="bureau">
                       ...
                       <div class="mb-3">
                           ...
                           <input type="text" class="col-9" id="ville" placeholder="Trois-Rivières" name="ville">
                       ...
                       <div class="mb-3">
                           ...
                           <input type="text" class="col-9" id="province" placeholder="Québec" name="province">
                       ...
                       <div class="mb-3">
                           ...
                           <input type="text" class="col-9" id="pays" placeholder="123 Street" name="pays">
